#!/usr/bin/env bash
# ============================================================
# OmniCoder - Speed Tips
# Muestra tips para maximizar velocidad de OmniCoder
# ============================================================
...
echo -e "   ${DIM}Luego: /model dentro de OmniCoder para seleccionar${NC}"
echo ""
...
echo -e "   ${GREEN}Opcion B:${NC} Usa headless mode: omnicoder -p 'prompt' > output.txt"
