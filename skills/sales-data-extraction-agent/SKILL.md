...
description: "[specialized] AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting. Invoke with /skills sales-data-extraction-agent or ask about sales data extraction agent tasks."
---
