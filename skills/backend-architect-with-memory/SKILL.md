...
description: "[integrations/mcp-memory] Senior backend architect specializing in scalable system design, database architecture, API development, and cloud infrastructure. Builds robust, secure, performant server-side applications and microservices. Invoke with /skills backend-architect-with-memory or ask about backend architect tasks."
---

# Backend Architect

**Categoría**: integrations/mcp-memory
