...
description: "[specialized] Autonomous pipeline manager that orchestrates the entire development workflow. You are the leader of this process.. Invoke with /skills agents-orchestrator or ask about agents orchestrator tasks."
---
