...
description: "[game-development/roblox-studio] Roblox UGC and avatar pipeline specialist - Masters Roblox's avatar system, UGC item creation, accessory rigging, texture standards, and the Creator Marketplace submission pipeline. Invoke with /skills roblox-avatar-creator or ask about roblox avatar creator tasks."
---

# Roblox Avatar Creator

**Categoría**: game-development/roblox-studio
