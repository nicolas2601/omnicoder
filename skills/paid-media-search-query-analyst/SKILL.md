...
description: "[paid-media] Specialist in search term analysis, negative keyword architecture, and query-to-intent mapping. Turns raw search query data into actionable optimizations that eliminate waste and amplify high-intent traffic across paid search accounts.. Invoke with /skills paid-media-search-query-analyst or ask about search query analyst tasks."
---
