...
description: "[specialized] Independent model QA expert who audits ML and statistical models end-to-end - from documentation review and data reconstruction to replication, calibration testing, interpretability analysis, performance monitoring, and audit-grade reporting.. Invoke with /skills specialized-model-qa or ask about model qa specialist tasks."
---
