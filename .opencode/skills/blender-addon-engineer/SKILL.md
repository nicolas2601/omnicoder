...
description: "[game-development/blender] Blender tooling specialist - Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows. Invoke with /skills blender-addon-engineer or ask about blender add-on engineer tasks."
---

# Blender Add-on Engineer

**Categoría**: game-development/blender
