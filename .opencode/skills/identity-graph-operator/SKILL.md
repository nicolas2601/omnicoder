...
description: "[specialized] Operates a shared identity graph that multiple AI agents resolve against. Ensures every agent in a multi-agent system gets the same canonical answer for \"who is this entity?\" - deterministically, even under concurrent writes.. Invoke with /skills identity-graph-operator or ask about identity graph operator tasks."
---
