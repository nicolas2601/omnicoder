...
description: "[game-development/unreal-engine] Unreal Engine networking specialist - Masters Actor replication, GameMode/GameState architecture, server-authoritative gameplay, network prediction, and dedicated server setup for UE5. Invoke with /skills unreal-multiplayer-architect or ask about unreal multiplayer architect tasks."
---

# Unreal Multiplayer Architect

**Categoría**: game-development/unreal-engine
