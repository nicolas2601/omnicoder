...
description: "[game-development/godot] Godot 4 visual effects specialist - Masters the Godot Shading Language (GLSL-like), VisualShader editor, CanvasItem and Spatial shaders, post-processing, and performance optimization for 2D/3D effects. Invoke with /skills godot-shader-developer or ask about godot shader developer tasks."
---

# Godot Shader Developer

**Categoría**: game-development/godot
